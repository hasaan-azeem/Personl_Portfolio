...
const projects = [
  {
    title: "Nordvia Exports - Ecommerce",
          ...
          >
            ...
            <a href={project.link} target="_blank" rel="noopener noreferrer">
              <img
                src={project.image}
                alt={project.title}
                className="w-full h-40 sm:h-48 object-fit rounded-md mb-4 -mt-2"
              />
            </a>
            ...
            <p className="text-gray-600 text-xs mb-2">{project.date}</p>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {project.tech.map((tech, i) => (
                <span
                  key={i}
                  className="text-xs px-2 py-1 bg-black text-gray-200 rounded-md"
                >
                  {tech}
                </span>
              ))}
            ...
            <div className="flex gap-2 mt-1">
              <a
                ...
                className="flex-1 inline-flex justify-center items-center gap-1 px-3 py-1.5 text-xs font-medium text-white bg-gray-900 rounded-xl hover:bg-gray-800 transition"
              >
                <svg
